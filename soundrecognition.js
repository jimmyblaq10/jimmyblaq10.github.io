 ...
 const socialMedia = ['Facebook', 'Instagram', 'Google', 'YouTube', 'Twitter', 'Gmail']
 ...
 recognition.addEventListener('result', e=>{
     ...
     if(e.results[0].isFinal){
         if(text.includes('who are you') || text.includes('what is your name') || text.includes("what's your name")){
             ...
             p.innerText = `My name is big jim. I am a robot created by jimmyblaq, He is still working on me, 
